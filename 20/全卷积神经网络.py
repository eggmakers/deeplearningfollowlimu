...
conv_trans = nn.ConvTranspose2d(
    3, 3, kernel_size=4, padding=1, stride=2,
    bias=False)
conv_trans.weight.data.copy_(bilinear_kernel(3, 3, 4))

img = torchvision.transforms.ToTensor()(
    d2l.Image.open('F:/code/deeplearningfollowlimu/d2l-zh/pytorch/img/catdog.jpg'))
X = img.unsqueeze(0)
Y = conv_trans(X)
...
#用双线性插值的上采样初始化转置卷积层。对于卷积层，我们使用Xavier初始化参数
...
num_epochs, lr, wd, devices = 10, 0.001, 1e-3, d2l.try_all_gpus()
